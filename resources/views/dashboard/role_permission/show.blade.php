                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title"> حــي {{$district->name_ar}}</h2>
                        </div>
                        <!--begin::Form-->
                                    ...
                                    <div class="mb-2">
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" disabled class="form-control"  value="{{$district->name_en }}" />
                                            </div>
                                            <div class="col-lg-6">
                                                <label>* اسم الحي بالعربيه :</label>
                                                <input type="text" disabled class="form-control"  value="{{ $district->name_ar }}" />
                                            </div>
                                            <div class="col-lg-12 mt-10">
                                                <label>* اسم المدينه :</label>
                                                <input type="text"  class="form-control" disabled value="{{$district->city->name_ar . ' - ' . $district->city->name_en }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
