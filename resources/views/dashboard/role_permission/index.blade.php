            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{route('districts.create')}}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
...
@endsection
@push('scripts')
    <script src="{{asset('js/datatables/districts.js')}}"></script>
@endpush
