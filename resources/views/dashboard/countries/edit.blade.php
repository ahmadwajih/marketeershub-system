                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title"> تعديل  : {{$country->name}}</h2>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('admin.countries.update',$country->id)}}" method = "POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <div class="mb-2">
                                        <label class="col-12 text-center mb-5">تعديل صورة العلم</label>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="أدخل اسم الدولة"  value="{{old('name') ?: $country->name}}" />
                                                @if ($errors->has('name'))
                                                    <div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="text" name="code" class="form-control" placeholder="أدخل كود الدولة "  value="{{old('code') ?: $country->code}}" />
                                                @if ($errors->has('code'))
                                                    <div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <label>* اللغة :</label>
                                                <select class="form-control select2" id="kt_select_language_id" name="language_id">
                                                    @foreach($languages as $lang)
                                                        <option value="{{$lang->id}}" @if($country->language_id==$lang->id) selected @endif>{{$lang->name}}</option>
                                                    @endforeach
                                                </select>
