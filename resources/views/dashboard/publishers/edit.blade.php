            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('dashboard.publishers.update',$publisher->id)}}" method = "POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                ...
                                                <select class="form-control select2" id="kt_select_team" name="team" >
                                                    <option {{ $publisher->team=='management'?'selected':'' }} value="management">{{ __('Management') }}</option>
                                                    <option {{ $publisher->team=='digital_operation'?'selected':'' }} value="digital_operation">{{ __('Digital Operation') }}</option>
                                                    <option {{ $publisher->team=='finance'?'selected':'' }} value="finance">{{ __('Finance') }}</option>
