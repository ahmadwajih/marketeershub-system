                    ...
                    <div class="card-toolbar">
                        ...
                        <a href="{{route('admin.users.create')}}" class="btn btn-primary font-weight-bolder ">
											<span class="svg-icon svg-icon-md">
                                                ...
                                                <!--end::Svg Icon-->
											</span>إضـافه مستخدم جـديد
                        </a>

                        <a href="#"  class="btn btn-primary font-weight-bolder ml-5" id="deletedAll">
                            <span class="svg-icon svg-icon-md">
                                <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
                                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
...
@push('scripts')
<script>
    var route = "{{ getUrlAfterDomain(route('admin.users.index')) }}";
</script>
@if(Request::segment(2)=='trashed')
    <script src="{{asset('js/datatables/trashed/users.js')}}"></script>
@else
