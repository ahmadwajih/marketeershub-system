            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3>{{ __('Offer Requests') }}</h3>
                    </div>
                    <div class="card-toolbar">
                        <a href="{{route('dashboard.offerRequests.create')}}" class="btn btn-primary font-weight-bolder ">
...
@push('scripts')
<script>
    var route = "{{ route('dashboard.offerRequests.index') }}";
</script>

<script src="{{asset('js/datatables/offerRequests.js')}}"></script>
@endpush
