                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title">إضـافه عملة جديد</h2>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('admin.currencies.store')}}" method = "POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="mb-3">
                                    <div class="mb-2">
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                <label>* الأسم :</label>
                                                <input type="text" name="name" class="form-control" placeholder="أدخل اسم العملة  " value="{{old('name')}}" />
                                                @if ($errors->has('name'))
                                                <div>
                                            ...
                                            <div class="col-lg-4">
                                                <label>* الكود :</label>
                                                <input type="text" name="code" class="form-control" placeholder="أدخل كود العملة  " value="{{old('code')}}" />
                                                @if ($errors->has('code'))
                                                <div>
                                            ...
                                            <div class="col-lg-4">
                                                <label>* العلامة :</label>
                                                <input type="text" name="sign" class="form-control" placeholder="أدخل علامة العملة  " value="{{old('sign')}}" />
                                                @if ($errors->has('sign'))
                                                <div>
