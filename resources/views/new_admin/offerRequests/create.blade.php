...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bold my-1 fs-3">Add New Offer Request</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
    ...
    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
        action="{{ route('admin.offerRequests.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <!--begin::Main column-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select id="user_id" name="user_id" data-control="select2" class="form-select update-coupons">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <select id="offer_id" name="offer_id" data-control="select2" class="form-select update-coupons">
                                                <option selected value="">{{ __('No one') }}</option>
                                                @foreach ($offers as $offer)
                                                    <option {{ old('offer_id') == $offer->id ? 'selected' : '' }}
