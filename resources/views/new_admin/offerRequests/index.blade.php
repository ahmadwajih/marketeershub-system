                            ...
                            <form action="{{ route('admin.offerRequests.index') }}" method="GET">
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <!--begin::Input-->
                                        <div>
                                            <select id="publishers_filter" class="form-select form-select-solid publishers_filter" name="user_id" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62cfb00b8671a"
                                                >
                                                <option value="">No One</option>
