            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ App\Models\Offer::count() }}</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Offers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ App\Models\Coupon::count() }}</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Coupons</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ $totalNumbers->orders }}</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ round($totalNumbers->sales, 2) }}$</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Sales</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ round($totalNumbers->revenue, 2) }}$</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Revenue</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ round($totalNumbers->payout, 2) }}$</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Payout</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
        ...
        <div class="col-sm-6 col-xl-4 mb-xl-10">
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        <!--begin::Number-->
                        <span class="fw-semibold fs-3x text-gray-800 lh-1 ls-n2">{{ round($totalNumbers->revenue - $totalNumbers->payout, 2) }}$</span>
                        <!--end::Number-->
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Gross Margin</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Publishers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Affiliates</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Influencers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Account Managers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Affiliates Account Managers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Influencer Account Managers</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Heads</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Affliliates Head</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
            ...
            <div class="card h-lg-100">
                ...
                <div class="card-body d-flex justify-content-between align-items-start flex-column">
                    ...
                    <div class="d-flex flex-column my-7">
                        ...
                        <!--begin::Follower-->
                        <div class="m-0">
                            <span class="fw-semibold fs-6 text-gray-400">Influencers Head</span>
                        </div>
                        <!--end::Follower-->
                    </div>
                    <!--end::Section-->
