    ...
    <div class="aside-menu flex-column-fluid px-4">
        ...
        <div class="hover-scroll-overlay-y my-5 pe-4 me-n4" id="kt_aside_menu_wrapper" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="{default: '#kt_aside_footer', lg: '#kt_header, #kt_aside_footer'}" data-kt-scroll-wrappers="#kt_aside, #kt_aside_menu" data-kt-scroll-offset="{default: '5px', lg: '75px'}">
            ...
            <div class="menu menu-column menu-rounded menu-sub-indention fw-semibold fs-6" id="#kt_aside_menu" data-kt-menu="true">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            ...
                            <a class="menu-link  {{ Request::segment(2)=='users'&&Request::segment(3)=='create'?'active':'' }}" href="{{ route('admin.users.create') }}">
                                ...
                                <span class="menu-title">Add New Members</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::segment(2)=='publishers'|| Request::segment(2)=='publishers-search' ?'here show':'' }}">
                    ...
                    <span class="menu-link">
                        ...
                        @if(auth()->user()->team == 'affiliate')
                            <span class="menu-title">{{ __('Affiliates Database') }} </span>
                        @elseif (auth()->user()->team == 'influencer')
                            <span class="menu-title">{{ __('Influencers Database') }}</span>
                        @else
                            <span class="menu-title">{{ __('Publishers') }}</span>
                        @endif
                        <span class="menu-arrow"></span>
                    </span>
                    <!--end:Menu link-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='publishers'&&Request::segment(3)=='' && request()->account_status == ''?'active':'' }}" href="{{ route('admin.publishers.index') }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">{{ __('View All') }}</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='publishers'&&Request::segment(3)=='create'?'active':'' }}" href="{{route('admin.publishers.create')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='publishers'&&Request::segment(3)=='upload'?'active':'' }}" href="{{route('admin.publishers.upload.form')}}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Bulk Upload Publisher</span>
                            </a>
                            <!--end:Menu link-->
                        </div>
                        <!--end:Menu item-->
                ...
                <div class="menu-item">
                   <!--begin:Menu link-->
                   <a class="menu-link {{ Request::segment(2)=='roles'?'active':'' }}" href="{{ route('admin.roles.index') }}">
                       <span class="menu-icon">
               ...
               @endcan
                ...
                <div class="menu-item pt-5">
                    <!--begin:Menu content-->
                    <div class="menu-content">
                        <span class="menu-heading fw-bold text-uppercase fs-7">Work Environment</span>
                    </div>
                    <!--end:Menu content-->
                </div>
                ...
                @can('view_pivot_report') 
                 ...
                 <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='reports'?'active':'' }}" href="{{ route('admin.reports.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span class="menu-title">{{ __('Update Report') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                @can('view_coupons')
                   ...
                   <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='coupons'?'active':'' }}" href="{{ route('admin.coupons.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="menu-icon">
                                <!--begin::Svg Icon | path: icons/duotune/communication/com005.svg-->
                ...
                @can('view_offer_requests')
                   ...
                   <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='offerRequests'?'active':'' }}" href="{{ route('admin.offerRequests.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="menu-icon">
                        ...
                        <span class="menu-title">{{ __('Offer Requests') }}</span>
                    </a>
                    <!--end:Menu link-->
                </div>
                <!--end:Menu item-->
                ...
                @can('view_advertisers') 
                 ...
                 <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='advertisers'?'active':'' }}" href="{{ route('admin.advertisers.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @can('view_categories') 
                 ...
                 <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='categories'?'active':'' }}" href="{{ route('admin.categories.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @can('view_countries') 
                 ...
                 <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='countries'?'active':'' }}" href="{{ route('admin.countries.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.3" d="M12 22C17.5228 22 22 17.5228 22 12C22 6.47715 17.5228 2 12 2C6.47715 2 2 6.47715 2 12C2 17.5228 6.47715 22 12 22Z" fill="currentColor"/>
                ...
                @can('view_cites') 
                 ...
                 <div class="menu-item">
                    <!--begin:Menu link-->
                    <a class="menu-link {{ Request::segment(2)=='cities'?'active':'' }}" href="{{ route('admin.cities.index') }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotune/general/gen014.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                @endcan
                @can('view_trashed')
                <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ Request::segment(2)=='trashed'?'here show':'' }}">
                    <!--begin:Menu link-->
                    <span class="menu-link">

                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/docs/metronic/html/releases/2022-10-09-043348/core/html/src/media/icons/duotune/files/fil015.svg-->
                            <span class="svg-icon svg-icon-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='users'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Team Members</span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='roles'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='publishers'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='offers'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='coupons'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='advertisers'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Advertisers</span>
                    ...
                    <div class="menu-sub menu-sub-accordion">
                        ...
                        <div class="menu-item">
                            <!--begin:Menu link-->
                            <a class="menu-link {{ Request::segment(2)=='trashed'&&Request::segment(3)=='categories'?'active':'' }}" href="{{ route('admin.trashed.index', ['model' => 'users']) }}">
                                <span class="menu-bullet">
                                    <span class="bullet bullet-dot"></span>
                                </span>
                                <span class="menu-title">Categories</span>
