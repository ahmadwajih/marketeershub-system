    ...
    <div class="card mb-5 mb-xxl-8">
        <div class="card-body pt-9 pb-0">
            ...
            <div class="form">
                ...
                <form class="mx-auto w-100 pt-15 pb-10" novalidate="novalidate" id="kt_modal_create_project_form" method="post">
    ...
    <div id="offers" class="tab fade-out-tab">
        <div class="row g-5 g-xxl-8">
            ...
            <div class="d-flex flex-wrap flex-stack">
                ...
                <span class="fs-6 text-gray-400 fw-semibold ms-1">({{ count($publisher->offers) }})</span></h3>
                <!--end::Title-->
                <!--begin::Controls-->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body d-flex flex-center flex-column py-9 px-5">
                            ...
                            <div class="symbol symbol-65px symbol-circle mb-5">
                                <img src="{{ getImagesPath('Offers', $offer->thumbnail) }}" alt="{{ $offer->name }}" />
                            ...
                            <!--end::Position-->
                             ...
                             <div class="d-flex flex-wrap mb-5">
                                ...
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-2 mb-3">
                                    <div class="fs-6 text-gray-800 fw-bold">100</div>
                                    <div class="fw-semibold text-gray-400">Order</div>
                                </div>
                                <!--end::Due-->
                                <!--begin::Budget-->
                                <div class="border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 mb-3">
                                    <div class="fs-6 text-gray-800 fw-bold">$500</div>
