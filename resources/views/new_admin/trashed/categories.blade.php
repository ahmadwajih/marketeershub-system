...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bold my-1 fs-3">Categories List</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Categories List</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
...
@push('scripts')
<script>
    var route = "{{route('admin.trashed.index', ['model'=>'categories'])}}";
    var restoreRoute = "{{route('admin.trashed.restore')}}";
</script>
<script src="{{ asset('new_dashboard') }}/js/datatables/categories/trashed-table.js"></script>
