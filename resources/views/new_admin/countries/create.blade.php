...
@section('content')
    ...
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bold my-1 fs-3">Add New Country</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
    ...
    <!--begin::Form-->
    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" action="{{route('admin.countries.store')}}" method="POST" enctype="multipart/form-data">
        @csrf
        <!--begin::Main column-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name_en" class="form-control mb-2" placeholder="Name EN" value="{{ old('name_en') }}" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="name_ar" class="form-control mb-2" placeholder="Name AR" value="{{ old('name_ar') }}" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="code" class="form-control mb-2" placeholder="Code" value="{{ old('code') }}" />
                                            @if ($errors->has('code'))
