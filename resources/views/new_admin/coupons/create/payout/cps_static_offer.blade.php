                ...
                <div data-repeater-item class="custom-class-in-form-repeater">
                    ...
                    <div class="form-group row mb-5">
                        ...
                        <div class="col-md-4">
                            ...
                            <input class="form-control" data-kt-repeater="datepicker" type="text" name="from_date" placeholder="Pick a date"  value="{{ isset($oldStaticpayout['from_date']) ? $oldStaticpayout['from_date'] : null }}" {{ isset($oldStaticpayout['date_range']) &&  $oldStaticpayout['date_range'][0] == 'on' ? '' : 'disabled' }}/>
                        </div>
                        <div class="col-md-4">
                            <label class="form-label">To Date:</label>
                            <input class="form-control" data-kt-repeater="datepicker" type="text" name="to_date" placeholder="Pick a date"  value="{{ isset($oldStaticpayout['to_date']) ? $oldStaticpayout['to_date'] : null }}" {{ isset($oldStaticpayout['date_range']) &&  $oldStaticpayout['date_range'][0] == 'on' ? '' : 'disabled' }}/>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-check form-switch form-check-custom form-check-solid mt-13">
                                ...
                                value="{{ isset($oldStaticpayout['countries']) ? $oldStaticpayout['countries'][0] : 'off'  }}" {{ isset($oldStaticpayout['countries']) &&  $oldStaticpayout['countries'][0] == 'on' ? 'checked' : ''  }}  />
                                <label class="form-check-label">
                                    Countries
                                </label>
                            </div>
