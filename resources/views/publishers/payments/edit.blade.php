...
@section('content')
    <div class="toolbar mb-5 mb-lg-7" id="kt_toolbar">
        ...
        <div class="page-title d-flex flex-column me-3">
            <!--begin::Title-->
            <h1 class="d-flex text-dark fw-bold my-1 fs-3">Edit Payments</h1>
            <!--end::Title-->
            <!--begin::Breadcrumb-->
            <ul class="breadcrumb breadcrumb-dot fw-semibold text-gray-600 fs-7 my-1">
                ...
                <!--end::Item-->
                <!--begin::Item-->
                <li class="breadcrumb-item text-gray-500">Edit Payments</li>
                <!--end::Item-->
            </ul>
            <!--end::Breadcrumb-->
        </div>
    ...
    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row"
        action="{{ route('admin.payments.update', $payment->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <!--begin::Main column-->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <select  name="publisher_id" data-control="select2" class="form-select publishers_filter">
                                                ...
                                                <option value="{{ $payment->publisher->id }}" selected>{{ $payment->publisher->name }}</option>
                                            </select>
                                            <!--end::Input-->
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" name="amount_paid" class="form-control mb-2" value="{{ old('amount_paid') ?? $payment->amount_paid }}" />
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <select  name="type" data-control="select2" class="form-select">
                                                ...
                                                <option {{ old('type')  == 'validation' ? 'selected' : ($payment->type == 'validation' ? 'selected' : '')}} value="validation">{{ __('Validations') }}</option>
                                                <option {{ old('type')  == 'update' ? 'selected' : ($payment->type == 'update' ? 'selected' : '')}} value="update">{{ __('Updates') }}</option>
                                            </select>
                                            <!--end::Input-->
                                            @if ($errors->has('type'))
                                                <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="date" name="from" class="form-control mb-2" value="{{ old('from') ?? $payment->from }}" />
                                            @if ($errors->has('from'))
                                                <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="date" name="to" class="form-control mb-2" value="{{ old('to') ?? $payment->to }}" />
                                            @if ($errors->has('to'))
                                                <div class="fv-plugins-message-container invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-10 fv-row">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <textarea class="form-control mb-2" name="note" cols="30" rows="10">{{ old('note') ?? $payment->note }}</textarea>
                                            @if ($errors->has('note'))
                                                <div class="fv-plugins-message-container invalid-feedback">
