                    ...
                    <div class="d-flex justify-content-between align-items-start flex-wrap mb-2">
                        ...
                        <div class="d-flex flex-column">
                            ...
                            <div class="d-flex flex-wrap fw-semibold fs-6 mb-4 pe-2">
                                ...
                                <!--end::Svg Icon-->{{ auth()->user()->parent->name }}</a>
                                @endif
                                ...
                                <!--end::Svg Icon-->{{ ucfirst(str_replace('_', ' ', auth()->user()->team)) }}</a>
                        ...
                        <div class="d-flex my-4">
                            <a href="{{ route('publisher.profile.edit', $user->id) }}" class="btn btn-sm btn-primary me-2">{{ __('Edit Profile') }}</a>
                            <!--begin::Menu-->
                        </div>
                        <!--end::Actions-->
                    </div>
