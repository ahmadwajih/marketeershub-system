    ...
    <div id="kt_docs_repeater_advanced_new_old_payout">
        ...
        <div class="form-group">
            <div data-repeater-list="new_old_payout">
                @if($coupon->payout_cps_type == 'new_old' && count($coupon->cps->where('type', 'payout')) > 0)
                    @foreach ($coupon->cps->where('type', 'payout') as $cps)
                            ...
                            <div class="form-group custom-class-in-form-repeater row mb-5">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        value="{{ old('payout') ?? $cps->new_amount }}" />
                                        <!--end::Input-->
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="row">
                                        ...
                                        value="{{ old('old_payout') ?? $cps->old_amount }}" />
                                        <!--end::Input-->
                                ...
                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mt-9">
                                        <input class="form-check-input form-check-input-payout switcher" data-input="text" name="date_range" type="checkbox" onchange="switcherFunction(this)" {{ $cps->date_range ? 'checked' : '' }}
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" data-kt-repeater="datepicker"  value="{{ $cps->from_date }}" placeholder="Pick a date" {{ $cps->date_range ? '' : 'disabled' }}/>
                                </div>
                                <div class="col-md-4">
                                    <label class="form-label">To Date:</label>
                                    <input class="form-control" data-kt-repeater="datepicker"  value="{{ $cps->to_date }}" placeholder="Pick a date" {{ $cps->date_range ? '' : 'disabled' }}/>
                                </div>

                                <div class="col-md-3">
                                    <div class="form-check form-switch form-check-custom form-check-solid mt-13">
                                        <input class="form-check-input form-check-input-payout switcher" name="countries" type="checkbox" data-input="select" onchange="switcherFunction(this)" {{ $cps->countries ? 'checked' : '' }}
