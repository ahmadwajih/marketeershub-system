...
@section('content')
    ...
    <div class="card card-flush w-lg-650px py-5">
        <div class="card-body py-15 py-lg-20">
            <!--begin::Title-->
            <h1 class="fw-bolder fs-2qx text-gray-900 mb-4">Unauthorized</h1>
            <!--end::Title-->
            <!--begin::Text-->
            <div class="fw-semibold fs-6 text-gray-500 mb-7">We are sorry but we are not able to authenticate you<br>Thanks.</div>
            <!--end::Text-->
            <!--begin::Illustration-->
            <div class="mb-11">
