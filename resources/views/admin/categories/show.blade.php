                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-4">
                                                ...
                                                <input class="form-control" disabled  value="{{$category->title_ar }}" />
                                            </div>
                                            <div class="col-lg-4">
                                                <label>Category Name In English</label>
                                                <input class="form-control" disabled  value="{{$category->title_en }}" />
                                            </div>
                                            <div class="col-lg-4">
                                                <label>{{ __('Type') }}</label>
                                                <input class="form-control" disabled  value="{{$category->type }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card card-custom example example-compact">
                            ...
                            <div class="card-body">
                                <table class="table table-bordered text-center">
                                    ...
                                    <tbody>
                                        @foreach(getActivity('Category',$category->id ) as $activity)
                                            <tr>
