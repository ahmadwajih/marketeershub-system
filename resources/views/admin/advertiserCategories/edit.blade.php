...
@section('title','Advertiser Category')
@section('content')
    <!--begin::Entry-->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        ...
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('admin.advertiserCategories.update',$category->id)}}" method = "POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
