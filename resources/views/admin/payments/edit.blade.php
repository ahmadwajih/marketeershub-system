                ...
                <div class="col-lg-12">
                    <div class="card card-custom example example-compact">
                        <div class="card-header">
                            <h2 class="card-title"> {{ __('Payment') }} {{ $payment->name }}</h2>
                        </div>
                        <!--begin::Form-->
                        <form class="form" id="kt_form" action="{{route('admin.payments.update',$payment->id)}}" method = "POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                                    ...
                                    <div class="mb-2">
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="number" step="0.1" name="amount_paid" class="form-control"  value="{{old('amount_paid') ?? $payment->amount_paid}}" required />
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control select2" id="kt_select_publisher_id" name="publisher_id">
                                                    @foreach($publishers as $publisher)
                                                        <option value="{{$publisher->id}}" {{old('publisher_id') == $publisher->id?'selected':($payment->publisher_id == $publisher->id ? 'selected':'')}}>{{$publisher->name}}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-6">
                                                ...
                                                <input type="date"  name="from" class="form-control"  value="{{old('from') ?? $payment->from}}" required />
                                                @if ($errors->has('from'))
                                                    <div>
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <input type="date"  name="to" class="form-control"  value="{{old('to')?? $payment->to}}" required />
                                                @if ($errors->has('to'))
                                                    <div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select class="form-control select2" id="kt_select_type" name="type">
                                                    <option value="validation" selected {{old('type') == 'validation'?'selected': ($payment->type == 'validation' ? 'selected':'')}}>{{ __('After Validation') }}</option>
                                                    <option value="update"  {{old('type') == 'update'?'selected': ($payment->type == 'update' ? 'selected':'')}}>{{ __('Upddate') }}</option>
                                                </select>
                                                @if ($errors->has('type'))
                                                <div>
