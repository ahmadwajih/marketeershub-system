    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <!--begin:Header-->
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url({{asset('dashboard/media/misc/bg-1.jpg')}})">
                        <h4 class="text-white font-weight-bold">{{__('Quick Actions')}}</h4>
                    </div>
                    <!--end:Header-->
                    <!--begin:Nav-->
                    <div class="row row-paddingless">
                        ...
                        <div class="col-6">
                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">{{__('Factories')}}</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-bottom">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">{{__('Products')}}</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light border-right">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">{{__('Orders')}}</span>
                            </a>
                        </div>
                        <!--end:Item-->
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="#" class="d-block py-10 px-5 text-center bg-hover-light">
                                ...
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">{{__('Traders')}}</span>
                            </a>
                        </div>
                        <!--end:Item-->
                    </div>
