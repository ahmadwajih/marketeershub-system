...
@endpush
@php
$columns = [['name' => 'id', 'label' => __('ID')], ['name' => 'thumbnail', 'label' => __('Thumbnail')], ['name' => 'offer', 'label' => __('Offer')], ['name' => 'status', 'label' => __('Status'), 'checked' => true], ['name' => 'payout', 'label' => __('Payout'), 'checked' => true], ['name' => 'target_market', 'label' => __('Target Market')], ['name' => 'discount', 'label' => __('Discount')], ['name' => 'action', 'label' => __('Actions'), 'checked' => true]];
$thead = '';
@endphp
@section('content')
                                                ...
                                                @if (in_array($offer->id, $offerRequestsArray))
                                                    ...
                                                    @if (getOfferRequest($offer->id))
                                                        ...
                                                        @if (getOfferRequest($offer->id)->status == 'pending')
                                                            <button
                                                                class="rounded btn btn-primary btn-xs mr-2">{{ __('In Review') }}</button>
                                                        @endif
