            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        ...
                        <div class="dropdown dropdown-inline mr-2">
                            <button type="button" class="btn btn-light-primary font-weight-bolder dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="svg-icon svg-icon-md">
                                    ...
                                    <!--end::Svg Icon-->
                                </span> <span class="m-2">إستخراج</span>
                            </button>
                            <!--begin::Dropdown Menu-->
                                ...
                                <ul class="navi flex-column navi-hover py-2">
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                                            ...
                                            <span class="navi-text">طباعه</span>
                                        </a>
                                    </li>
                                    <li class="navi-item">
                                        <a href="#" class="navi-link">
                        ...
                        <!--end::Dropdown-->
                        <!--begin::Button-->
                        <a href="{{route('admin.currencies.create')}}" class="btn btn-primary font-weight-bolder">
											<span class="svg-icon svg-icon-md">
...
@push('scripts')
    <script>
        var route = "{{ getUrlAfterDomain(route('admin.currencies.index')) }}";
    </script>
    @if(Request::segment(2)=='trashed')
        <script src="{{asset('js/datatables/trashed/currencies.js')}}"></script>
    @else
        <script src="{{asset('js/datatables/currencies.js')}}"></script>
    @endif
@endpush
