...
var KTFlotchartsDemo = function() {
	...
	var demo8 = function() {
		var data = [
            {label: "مستشفيات", data: hospitals_count, color:  KTApp.getSettings()['colors']['theme']['base']["success"]},
            {label: "معامل التحاليل", data: labs_count, color:  KTApp.getSettings()['colors']['theme']['base']["danger"]},
            {label: "مراكز الأشعه", data: x_ray_count, color:  KTApp.getSettings()['colors']['theme']['base']["warning"]}
        ];
